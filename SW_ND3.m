function [sc,nu,a]=SW_ND3(T,S)

% Setch•now equation 
% The Solubility of CO 2 in Water and Sea Water (JGR 1971)
cl=55*S/100; % Cl => about 55% of sea water
a_n=770.5-29.78.*T+0.6823*T.^2-0.0079*T.^3;
a_dn=exp((0.0040-0.00037.*T).*cl);
a1=a_n./a_dn;
a=10.^-4.*a1*44/2;% solubility of CO2

% schmidt number
A=2216.8; B=-135.25; C=4.7353; D=-0.092307; E=0.0007555;
sc=A+B.*T+C.*T.^2+D.*T.^3+E.*T.^4;
% from SW_Kviscosity2.m
